...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'kord_ai-xPuwEEYYYa4rOEI4',
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2449040165195",
    ...
    OWNER_NAME: process.env.OWNER_NAME || "HABEEB",
    BOT_NAME: process.env.BOT_NAME || "HABEEB BOT",
